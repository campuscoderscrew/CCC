...
export type SectorNames =
  ...
  | "Internal Operations"
  | "External Operations"
  // Members who hold no active position sit under the Passive Roster sector;
  // its "departments" are the roster states below.
  | "Passive Roster";
...
export interface Position {
  ...
  // Board-level positions (President, general Advisor) sit outside any sector or
  // department; only development positions carry a team and cluster.
