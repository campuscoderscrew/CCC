...
export default function Hero() {
  return (
    <section
      style={{
        background:
          "linear-gradient(hsl(190, 85%, 80%), hsl(195, 80%, 95%) 70%)",
    ...
    >
      ...
      >
        ...
        >
          ...
          community of developers and build websites for various campus groups.
        </p>
      </div>
        ...
        >
          ...
          <g className="wave-parallax">
            <use
              ...
              x="48"
              y="0"
              fill="rgba(6, 89, 145, 0.6)"
            />
            <use
              xlinkHref="#gentle-wave"
              x="48"
              y=".5"
              fill="rgba(6, 89, 145, 0.4)"
            />
            <use
              xlinkHref="#gentle-wave"
              x="48"
              y="1"
              fill="rgba(6, 89, 145, 0.2)"
            />
            <use
              xlinkHref="#gentle-wave"
              x="48"
      ...
      >
        ...
        >
          We are a group of students interested in hands on experience in
          software engineering. Our club takes students out of the typical
          classroom setting and into a community of thinkers, builders, and
          dreamers.
        </p>
      ...
      >
        ...
        <path
          d="M600 2.96986V11.6009V29.9976H0V11.6009C42.8364 11.4173 135.33 22.1338 290.592 9.98004C445.855 -2.1737 554.44 -1.51879 600 2.96986Z"
          fill="#085A91"
        />
        <path
          d="M600 14.1388V24.293V29.9975H0V24.293C42.8364 24.077 135.33 36.6846 290.592 22.3861C445.855 8.08758 554.44 8.85806 600 14.1388Z"
          fill="#F5EED6"
        />
      </svg>
    </section>
