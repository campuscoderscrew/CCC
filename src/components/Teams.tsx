...
const TEAMS: Team[] = [
  {
    ...
    name: "Team Whale",
    members: [
      { id: "w1",  name: "Lorem Ipsum", isLead: true, avatarUrl: blankIcon },
      { id: "w2",  name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "w3",  name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "w4",  name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "w5",  name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "w6",  name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "w7",  name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "w8",  name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "w9",  name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "w10", name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "w11", name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "w12", name: "Lorem Ipsum", avatarUrl: blankIcon },
    ],
  },
  {
    id: "shark",
    name: "Team Shark",
    members: [
      { id: "s1", name: "Lorem Ipsum", isLead: true, avatarUrl: blankIcon },
      { id: "s2", name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "s3", name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "s4", name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "s5", name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "s6", name: "Lorem Ipsum", avatarUrl: blankIcon },
    ],
  },
  {
    id: "dolphin",
    name: "Team Dolphin",
    members: [
      { id: "d1", name: "Lorem Ipsum", isLead: true, avatarUrl: blankIcon },
      { id: "d2", name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "d3", name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "d4", name: "Lorem Ipsum", avatarUrl: blankIcon },
      { id: "d5", name: "Lorem Ipsum", avatarUrl: blankIcon },
    ],
  },
];
